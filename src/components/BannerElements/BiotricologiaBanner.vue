<template>
  <div class="wsBanner wsBanner--biotricologia">
    <span v-touch:swipe.left="toLeft" v-touch:swipe.right="toRight">
      <div class="wsBanner__header wsBanner__background--biotricologia">
        <div class="wsBanner__watermark--light" data-sectionName="#Biotricologia"></div>
        <b-img
          :src="logoWhite"
    ...
    <b-container fluid class="wsBanner__body">
      ...
      >
        <span class="pulse-ring--light">Details</span>
      </button>
      <button
        v-b-toggle.main-collapse
        variant="transparent"
